...
Updated in version 2.0, with the following changes from the [previous version](v1_1.md):

- Moved the MNN-corrected PCs to [`batch_correction`](../batch_correction/v2_0.md).
