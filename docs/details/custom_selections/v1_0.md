...
- `selections`: a group defining the custom selections.
  ...
  Note that indices refer to the dataset after QC filtering and should be less than the number of cells (i.e., `num_cells` in `custom_selections::validate()`).
