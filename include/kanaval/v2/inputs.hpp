#ifndef KANAVAL_INPUTS_V2_HPP
#define KANAVAL_INPUTS_V2_HPP
...
inline Parameters validate_parameters(const H5::Group& handle, bool embedded, int version) {
...
inline Details validate_results(const H5::Group& handle, const Parameters& param_info, int version) {
...
inline inputs::Details validate_inputs(const H5::Group& handle, bool embedded, int version) {
    ...
    inputs::Parameters dump; 
    try {
        dump = inputs::validate_parameters(ihandle, embedded, version);
    } catch (std::exception& e) {
    ...
    try {
        output = inputs::validate_results(ihandle, dump, version);
    } catch (std::exception& e) {
