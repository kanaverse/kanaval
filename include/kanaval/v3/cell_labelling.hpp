#ifndef KANAVAL_CELL_LABELLING_V3_HPP
#define KANAVAL_CELL_LABELLING_V3_HPP
...
inline void validate_cell_labelling(const H5::H5File& handle, int num_clusters, bool rna_available, int version) {
